...
- Los DataNodes almacenan los Chunks en la carpeta "Chunks", se puede ingresar con ‘cd Chunks' en cada máquina.

- El ClienteDownloader almacena los Chunks en la carpeta "Chunks", se puede ingresar con ‘cd Chunks'; los libros 
descargados por el ClienteDownloader se almacenan en la carpeta "Descargas", se puede ingresar con ‘cd Chunks'.
